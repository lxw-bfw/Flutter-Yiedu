...
//使用短信登录
class LoginByMessage extends StatefulWidget {
  LoginByMessage({Key key}) : super(key: key);

// 管理此widget状态和界面的State实例
  @override
  LoginByMessageState createState() => LoginByMessageState();
}

// 界面状态还有样式的控制
class LoginByMessageState extends State<LoginByMessage> {
  //验证码倒计时定时器
  Timer _timer;
  //验证码倒计时数值
  var countdownTime = 0;
